...
{{< figure src="monthly_by_frame.png" alt="plot" caption="Monthly meetings by thematic frame" >}}

{{< figure src="atlanta_adjacent_effect_7d.png" alt="plot" caption="Atlanta shooting effect by spatial proximity, 7-day window" >}}

{{< figure src="atlanta_adjacent_effect_30d.png" alt="plot" caption="Atlanta shooting effect by spatial proximity, 30-day window" >}}

{{< figure src="atlanta_democrat_effect_7d.png" alt="plot" caption="Atlanta shooting effect by state partisanship, 7-day window" >}}

{{< figure src="atlanta_democrat_effect_30d.png" alt="plot" caption="Atlanta shooting effect by state partisanship, 30-day window" >}}